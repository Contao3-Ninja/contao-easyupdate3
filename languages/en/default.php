...
$GLOBALS['TL_LANG']['easyupdate3']['noupdatetext'] = 'You can select files which are not updated. But the backup catch also these files.';
$GLOBALS['TL_LANG']['easyupdate3']['updatex'] = 'version (%s) ======> version (%s)';
$GLOBALS['TL_LANG']['easyupdate3']['update0'] = 'You will install an older version of Contao. This is not impossible, are you sure? The version 2.7 have new passwords, so a update to a lower version can be become not so easy.';
